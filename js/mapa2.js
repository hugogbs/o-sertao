        ...
        var subtitleScale = 
            d3.scaleOrdinal([d3.rgb(24, 155, 0, 1.0), 
                            d3.rgb(24, 155, 0, 0.8), 
                            d3.rgb(24, 155, 0, 0.6), 
                            d3.rgb(24, 155, 0, 0.4), 
                            d3.rgb(24, 155, 0, 0.2),
        ...
        function draw(error, sab, dados_sab) {
            ...
            color
                ...
                .range([d3.rgb(24, 155, 0, .2), d3.rgb(24, 155, 0, .4), d3.rgb(24, 155, 0, .6), d3.rgb(24, 155, 0, .8), d3.rgb(24, 155, 0, 1.0)], "#3333CC");
            ...
            svg.selectAll(".municipios")
                ...
                .on("mouseover", function(d){ 
                  ...
                  .text(getData(d.properties.ID).MUNICIPIO + " (" + 
                    ...
                    getData(d.properties.ID).populacao_abastecida +  ' habitantes')
                });
              ...
              for (var i = 0; i < dados_sab.length; i++) {
                 ...
                 svg.select("#area-"+cidade.GEOCODIGO )
                  .attr("fill", function() {
                if (isNaN(cidade.populacao_abastecida)) {
                   return "#3333CC";
                } else {
                   return color(+cidade.populacao_abastecida);
                 }
                })
              }

              var legend = g.selectAll(".legend")
                .data(["Entre 40001 e 50000", "Entre 30001 e 40000", "Entre 20001 e 30000", "Entre 10001 e 20000", "Entre 0 e 10000", "Não há dados" ])
                .enter().append("g")
                .attr("class", "legend")
